...
At the beginning, it searches the given directory for a txt files. If those exist the text is splitted into sentences and observed for specific expressions, as described above.\\
