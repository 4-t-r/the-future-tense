...
Since this paper focuses on analyzing statements about the future, a system for distinguishing between future statements and other expressions is required. In this context, we decided to train a model that accomplishes this task. Therefore, in this subsection, the collection of the appropriate training data and the subsequent training of this model is thematized.
