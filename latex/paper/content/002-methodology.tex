...
\begin{table}[t]
    ...
    \begin{tabular}{llll}
        ...
        \midrule
        AI can be a risk     & \multirow{2}{*}{NEG} & \multirow{2}{*}{finances} & ... \\
        for many workers.    &                      &                           & ... \\
        \addlinespace[0.7em]
        AI will definitely   & \multirow{2}{*}{POS} & \multirow{2}{*}{gaming}   & ... \\
        revolutionize games! &                      &                           & ... \\
        \addlinespace[0.7em]
        ...                  & ...                  & ...                       & ... \\
        \bottomrule
