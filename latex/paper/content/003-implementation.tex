...
The Model Pipeline and all the incorporated models are covered in detail below. This pipeline generates the final data set with the attributes future statement, sentiment, topic and url. The resulting data set can then be used for analysis and interpretation. 
